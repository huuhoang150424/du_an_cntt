                ...
                <div class="widget-row">
                    <div class="widget-row-col-1">
                        ...
                        <div class="widget-row-col-content">
                            <p>Family Food luôn đặt trải nghiệm sản phẩm  của khách hàng lên hàng đầu.</p>
                        </div>
                        <div class="widget-social">
                            <div class="widget-social-item">
                                <a href="https://www.facebook.com/profile.php?id=100022046420322&locale=vi_VN">
                        ...
                        <div class="contact">
                            ...
                            <div class="contact-item">
                                ...
                                <div class="contact-content conatct-item-email">
                                    <span>familyfood@gmail.com</span>
                                </div>
                            </div>
                        </div>
                    </div>
    ...
    <div class="copyright-wrap">
        <div class="container">
            <div class="copyright-content">
                <p>Cảm ơn các bạn đã  ghé qua, chúc mọi người ngon miệng</p>
            </div>
        </div>
    </div>
