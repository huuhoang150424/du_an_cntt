            ...
            <div class="col l-9">
                <div class="content-introduce__info">
                    ...
                    <div class="content__evaluate">
                        ...
                        <span class="content__evaluate-comment content__comment-evaluate">Được đánh giá là sản phẩm tốt</span>
                    </div>
                </div>
                    ...
                    <div class="row">
                        <div class="col l-5">
                            <div class="cat__slides">
                                ...
                                <div class="row_cat">
                                    <div class="column">
                                        <img src="upload/<?php echo $row['img1'] ?>" alt=""
                                            class="container-product__items-img" style="width:100%;height: 80px;"
                                            onclick="currentSlide(1)" alt="Cinque Terre">
                                    </div>
                                    <div class="column">
                                        <img class="demo cursor" src="upload/<?php echo $row['img2'] ?>"
                                            style="width:100%;height: 80px;" onclick="currentSlide(2)"
                                            alt="Cinque Terre">
                                    </div>
                                    <div class="column">
                                        <img class="demo cursor" src="upload/<?php echo $row['img3'] ?>"
                                            style="width:100%;height: 80px;" onclick="currentSlide(3)"
                                            alt="Mountains and fjords">
                                    </div>
                                    <div class="column">
                                        <img class="demo cursor" src="upload/<?php echo $row['img4'] ?>"
                        ...
                        <div class="col l-7">
                            <div class="content-product__right">
                                ...
                                <div class="content-product__right-code">
                                    ...
                                    <span class="content-product__code-num"><?php echo $row["dongiamoi"] ?> 000
                                        VNĐ</span>
                                </div>
                                <p class="content-product__right-msg">Mô tả:
                                    <?php echo $row["mota"] ?> Bạn cho giá thể đã xử lý nấm bệnh vào chậu cao cách miệng
                                    5cm. Trồng cây sao cho cây phân bố xung quanh chậu, không trồng cây quá sát thành
                                    chậu. Nên trồng cây vào buổi chiều, sau khi tưới nước đẫm cây.
                                </p>
                                <form action="cart.php" method="post" class="detail-items__quantity">
                                    <div class="content-product-left-select">
                                        ...
                                        <input class="detail-items__quantity-num" type="number" name="soluong" min="1"
                                            MAX="100" value="1">
                                        <input type="hidden" name="tensp" value="<?php echo $row["tensp"] ?>">
                                        <input type="hidden" name="dongiamoi"
                                            value="<?php echo $row["dongiamoi"] ?> 000 VNĐ">
                                    ...
                                    <div class="content-product__right-select">
                                        <span class="content-product__right-more">
                                            ...
                                            <input type="submit" value="Thêm vào giỏ hàng" name="addcart"
                                                class="content-product__select-cart">
                                        </span>
                                        <span>
                                            <input type="submit" value="Mua Ngay" name="addcart"
                                                class="content-product__select-btn">
