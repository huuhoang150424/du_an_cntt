...
// Unset giỏ hàng session chỉ khi ấn nút dong y dat hang
        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="container__cart-dad">
                    <h3 class="container-product__heading" style="color:green;font-weight:700;font-family: 'Roboto';">
                        GIỎ HÀNG ĐÓ</h3>
                    <div class="container-product__heading-border"></div>
                    <form action="bill.php" method="post">
                        <div class="shoping__cart__table my-[40px] ">
                            <table>
                                <thead>
                                    <tr>
                        ...
                        <div class="shoping__cart__btns">
                            ...
                            <a href="cart.php?delcart=1" class="primary-btn cart-btn cart-btn-right"><span
                                    class="fa fa-times" style="color:red"></span>
                                Xóa Giỏ Hàng</a>
                        </div>
                        <div class="shoping__checkout mb-[40px] ">
